  ...
  return (
    <main className="min-h-screen flex flex-col items-center px-4 py-20">
      <div className="max-w-2xl text-center">
        <h1 className="text-5xl font-bold mb-4 text-[var(--foreground)]">DevTrack</h1>
        ...
        <div className="flex gap-4 justify-center">
          ...
          <a
            ...
            className="border border-slate-600 text-[var(--foreground)] px-6 py-3 rounded-lg font-semibold hover:border-slate-400 transition"
          >
            View on GitHub
          </a>
        </div>
